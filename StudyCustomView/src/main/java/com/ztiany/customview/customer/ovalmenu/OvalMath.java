...
import com.android.base.utils.java.MathUtils;
...
public class OvalMath {
    ...
    public void calcPoint(float angle, PointF pointF) {
        float newX = (float) (Math.cos(MathUtils.angleToRadian(angle)) * mA + mCenterX);
        float newY = (float) (Math.sin(MathUtils.angleToRadian(angle)) * mB + mCenterY);

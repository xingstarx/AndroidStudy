...
public class MaskFilter extends View {
    ...
    private static final String TAG = MaskFilter.class.getSimpleName();
    ...
    public void setEmbossMaskFilter(float[] direction, float ambient, float specular, float blurRadius) {
        ...
        Log.d(TAG, "setEmbossMaskFilter() called with: " +
                "direction = [" + Arrays.toString(direction) + "], ambient = [" + ambient + "], specular = [" + specular + "], blurRadius = [" + blurRadius + "]");

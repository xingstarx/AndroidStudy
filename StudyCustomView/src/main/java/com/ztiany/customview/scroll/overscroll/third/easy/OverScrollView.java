...
package com.ztiany.customview.scroll.overscroll.third.easy;
...
public class OverScrollView extends ScrollView {
    ...
    private void updateHeaderView() {
        if (mHeaderView != null) {
            ...
            int widthSpec = MeasureSpec.makeMeasureSpec(mHeaderViewRect.width(), MeasureSpec.EXACTLY);
            int heightSpec = MeasureSpec.makeMeasureSpec(mHeaderViewRect.height(), MeasureSpec.EXACTLY);
    ...
    private void updateFooterView() {
        if (mFooterView != null) {
            ...
            int widthSpec = MeasureSpec.makeMeasureSpec(mFooterViewRect.width(), MeasureSpec.EXACTLY);
            int heightSpec = MeasureSpec.makeMeasureSpec(mFooterViewRect.height(), MeasureSpec.EXACTLY);

package com.android.base.utils.phototaker;
...
public class PhotoParams {
    ...
    public static final String SAVE_FILE_NAME = "save.jpg";
    ...
    public PhotoParams(File saveFile) {
        crop = "true";
        type = CROP_TYPE;
        uri = buildUri(saveFile, CROP_FILE_NAME);
        outputUri = buildUri(saveFile, SAVE_FILE_NAME);
        scale = true;
        returnData = true;
    ...
    private Uri buildUri(File saveFile, String name) {
        return Uri.fromFile(new File(saveFile, name));
    }
}

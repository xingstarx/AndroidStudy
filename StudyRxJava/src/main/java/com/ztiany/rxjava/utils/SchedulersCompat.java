package com.ztiany.rxjava.utils;


import com.android.base.concurrent.JobExecutor;
...
public class SchedulersCompat {
    ...
    private static final Observable.Transformer jobTransformer = new Observable.Transformer() {
        @Override
        public Object call(Object observable) {
            return ((Observable) observable).subscribeOn(Schedulers.from(JobExecutor.getJobExecutor()))
                    .observeOn(AndroidSchedulers.mainThread());
        }
    };
    ...
    public static <T> Observable.Transformer<T, T> applyExecutorSchedulers() {
        return (Observable.Transformer<T, T>) jobTransformer;
    }
}